...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** 设置SurfaceView的回调。 SurfaceView是个重量级组件，只要不可见就不会创建该组件。 * 所以要设置一个侦听，等待SurfaceView组件可见在播放视频，然而SurfaceView是没有侦听的，只要回调。 * 一定要注意，别导错了包（import android.view.SurfaceHolder.Callback;） */
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (player == null) {
                    ...
                    try {
                        ...
                        player.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/123.mp4");
